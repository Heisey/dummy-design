...
var Button = function (_a) {
    ...
    return (React.createElement(styles.Button, __assign({ type: "button", className: ['storybook-button', "storybook-button--" + size, mode].join(' '), style: { backgroundColor: backgroundColor } }, props), label));
};
