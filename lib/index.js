...
var PrimaryHeading = styled__default['default'].h1(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  font-size: 60px;\n  font-weight: ", ";\n  font-family: ", ";\n  text-transform: capitalize;\n  color: ", ";\n"], ["\n  font-size: 60px;\n  font-weight: ", ";\n  font-family: ", ";\n  text-transform: capitalize;\n  color: ", ";\n"])), function (props) { return props.theme.font.weight.bold; }, function (props) { return props.theme.font.families.primary; }, function (props) { return props.color; });
var SecondaryHeading = styled__default['default'].h1(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  font-size: 42px;\n  font-weight: ", ";\n  font-family: ", ";\n  text-transform: capitalize;\n  color: ", ";\n"], ["\n  font-size: 42px;\n  font-weight: ", ";\n  font-family: ", ";\n  text-transform: capitalize;\n  color: ", ";\n"])), function (props) { return props.theme.font.weight.bold; }, function (props) { return props.theme.font.families.primary; }, function (props) { return props.color; });
var TertiaryHeading = styled__default['default'].h1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  font-size: 27px;\n  font-weight: ", ";\n  font-family: ", ";\n  text-transform: capitalize;\n  color: ", ";\n"], ["\n  font-size: 27px;\n  font-weight: ", ";\n  font-family: ", ";\n  text-transform: capitalize;\n  color: ", ";\n"])), function (props) { return props.theme.font.weight.light; }, function (props) { return props.theme.font.families.primary; }, function (props) { return props.color; });
...
var Heading = function (props) {
    ...
    var handleHierarchy = function (hierarchy, args, text) {
        switch (hierarchy) {
            case 'secondary':
                return (React__default['default'].createElement(styles.SecondaryHeading, __assign({}, args), text));
            case 'tertiary':
                return (React__default['default'].createElement(styles.TertiaryHeading, __assign({}, args), text));
            default:
                return (React__default['default'].createElement(styles.PrimaryHeading, __assign({}, args), text));
        }
    };
...
var Heading$1 = styled.withTheme(Heading);
